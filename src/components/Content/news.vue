<template>
  ...
  <div id="news">
    <div class="Title"><span class="Title_">消息管理</span></div>
      <!--<table>-->
        <!--<thead>-->
          <!--<tr>-->
            <!--<td colspan="5">-->
              <!--<input class="input_" type="text" v-model="item.parameter.theme" placeholder="主 题">-->
              <!--<input class="input_" type="text" v-model="item.parameter.source" placeholder="来 源">-->
        ...
        <!--<tbody>-->
          <!--<tr v-for="row in info">-->
            <!--<td>{{row["number"]}}</td>-->
            <!--<td>{{row["source"]}}</td>-->
            <!--&lt;!&ndash;<td class="theme"><a href="row['http']">{{row["theme"]}}</a></td>&ndash;&gt;-->
            <!--<td>{{row["time"]}}</td>-->
            <!--<td><input type="button" value="阅 读" @click="read(row['number'])"> / <input type="button" value="阅 读" @click="del(row['number'])"></td>-->
          <!--</tr>-->
          <!--<tr>-->
            <!--<td>number</td>-->
            <!--<td>服务器</td>-->
            <!--<td class="theme"><a href="http://www.baidu.com">这是一条测试信息</a></td>-->
            <!--<td>5/26/16</td>-->
            <!--<td class="btn_">-->
              <!--<input class="input_btn1" type="button" value="阅 读" @click="read(row['number'])"> /-->
              <!--<input class="input_btn2" type="button" value="阅 读" @click="del(row['number'])">-->
            <!--</td>-->
          <!--</tr>-->
        <!--</tbody>-->
        <!--<tfoot>-->
          <!--<tr>-->
            <!--<td class="tfoot_td" colspan="5">选项</td>-->
          <!--</tr>-->
        <!--</tfoot>-->
      <!--</table>-->
